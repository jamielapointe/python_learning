...
Source: https://app.codesignal.com/arcade/python-arcade/complexity-of-comprehension/DfDPhgb5Bj2HQSdr5
...
def solution(n):
    ...
    return [[0 for x in range(i)] for i in range(1, n + 1)
           ] + [[0 for x in range(j)] for j in range(n - 1, 0, -1)]
